...
sheet_1 = Sheet.find_or_create_by(name: 'Поликарбонат "Воля" standart 6х2.1 м', description: '<p>Сотовый поликарбонат«Воля Standart» имеет стандартную структуру сот. На маркированной стороне листа нанесен специальный защитный UV-слой. Плотность сотового поликарбоната «Воля Standart» составляет 0,6 кг/м2.</p>

    <p>Срок службы "Воля" Standart - 6 лет</p>', price: 2400, cost: 2035)

sheet_2 = Sheet.find_or_create_by(name: 'Поликарбонат "Воля" medium 6х2.1 м', description: '<p>Сотовый поликарбонат «Воля Medium» имеет стандартную структуру сот. На маркированной стороне листа нанесен специальный защитный UV-слой. Плотность сотового поликарбоната «Воля Medium» составляет 0,7 кг/м2.</p>
    <p>Плотность сотового поликарбоната «Воля Standart» составляет 0,6 кг/м2.</p>

    <p>Срок службы "Воля" Standart - 6 лет</p>', price: 2800, cost: 2462)

sheet_3 = Sheet.find_or_create_by(name: 'Поликарбонат "Воля" Premium 6х2.1 м', description: '<p>Обычный поликарбонат состоит из пустых сот, поликарбонат "Воля" Premium имеет еще диагональную перегородку в каждой ячейке. Эта вспомогательная перегородка дополнительно усиливает поликарбонат, делая его сверхпрочным.</p>
...
<p>Срок службы "Воля" Premium – 15 лет.</p>', price: 3100, cost: 2728)
